...
void setup() {  
  ...
  while(!esp.find("OK"));                                     //Ağa bağlanana kadar bekliyoruz.//ok olana kadar bu satırı tekrarlıyor
...
void loop() {
  ...
  String veri = "GET https://api.thingspeak.com/update?api_key=S5L4UTJ4CPU5CBR2";   //Thingspeak komutu. Key kısmına kendi api keyimizi yazıyoruz.   
